...
export const mainRoute = (opts) => async (app) => {
    app.addHook('onRequest', roleHook(opts));
    for (const [modelName, { endpointName, schema, handlerAccesses },] of Object.entries(opts.schemas)) {
        ...
        app.register(subRoute(modelName, {
            schema,
            handlerAccesses,
            getSubarray,
            subPathName: '',
